...
int main() {
    ...
    assert(model.navigation.gps.source.value == ship_data_model::SensorSource::serial);
    ...
    wind.time_us = 200;
    wind.source = ship_data_model::SensorSource::signalk;
    ...
    assert(model.wind.apparent.source.value == ship_data_model::SensorSource::signalk);
